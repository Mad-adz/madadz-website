...
const Terms_Conditions = () => {
  return (
    <section
      ...
      className="py-5 term-banner"
    >
      <Container className="mt-5 text-white">
        <h1>Terms & Condition for Madadz</h1>
        <hr />
        <div className="py-2 text-white term-content">
          ...
          <ul>
            <li>
              <p>By email: madadzindia@gmail.com</p>
            </li>
            <li>
              <p>By phone number: +91 93616 24563</p>
            </li>
          </ul>
        </div>
      </Container>
